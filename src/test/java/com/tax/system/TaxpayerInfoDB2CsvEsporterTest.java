        ...
        try (Connection conn = DriverManager.getConnection(
            ...
            st.executeUpdate(
                    "CREATE TABLE IF NOT EXISTS taxpayer_info (" +
                            ...
                            "nhip_payment_special NUMERIC(13,0)," +
                            "nhip_payment_regular NUMERIC(13,0)," +
                            "nhip_status VARCHAR(1)," +
                            "care_payment_special NUMERIC(16,0)," +
                            "care_payment_regular NUMERIC(16,0)," +
                            ...
                            "late_elderly_payment_special NUMERIC(13,0)," +
                            "late_elderly_payment_regular NUMERIC(13,0)," +
                            ...
                            "operated_at DATE," +
                            "operated_time TIME," +
                            "CONSTRAINT taxpayer_info_pkey PRIMARY KEY (city_code, taxpayer_no, person_hist_no)" +
                            ")"
            );
        }
    }
